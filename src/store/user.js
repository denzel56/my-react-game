...
export const getUserUpdateAsync = () => async (dispatch) => {
  ...
  if (idToken) {
    ...
    const response = await fetch('https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAV4byPzlGzsM0ufr2_WLrkkJSEZI2DrxU', requestOptions).then(res => res.json());
